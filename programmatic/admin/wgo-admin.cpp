...
table.contest-edit-progress-bar {
		width: 100%;
		font-size: large;
		padding: 0;
		border-spacing: 0;
...
table.contest-edit-progress-bar a {
		display: block;
}

table.contest-edit-progress-bar td {
		width: 1%;
		border: none;
}

table.contest-edit-progress-bar td#current-position {
		width: 1%;
		border: 1px solid gray;
		background: none WGO_BLUE;
}

table.contest-edit-progress-bar td#prev,
table.contest-edit-progress-bar td#next {
		border: 1px solid black;
		font-size: normal;
		font-weight: bold;
}
